...
func (server *Server) UpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	//CHeck if the auth token is valid and  get the client id from it
	uid, err := auth.ExtractTokenID(r)
	if err != nil {
		responses.ERROR(w, http.StatusUnauthorized, errors.New("Unauthorized"))
		return
	...
	// If a client attempt to update a post not belonging to him
	if uid != post.AuthorID {
		responses.ERROR(w, http.StatusUnauthorized, errors.New("Unauthorized"))
		return
	}
	...
	//Also check if the request client id is equal to the one gotten from token
...
func (server *Server) DeletePost(w http.ResponseWriter, r *http.Request) {
	...
	// Is the authenticated client, the owner of this post?
	if uid != post.AuthorID {
		responses.ERROR(w, http.StatusUnauthorized, errors.New("Unauthorized"))
		return
	}
